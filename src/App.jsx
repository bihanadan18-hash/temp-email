    ...
    <div className="min-h-screen bg-neutral-950 text-neutral-100 font-sans p-4 md:p-8">
      <div className="max-w-5xl mx-auto">
        <header className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-4xl font-black tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-neutral-500 text-center">
            PRIVATE MAIL
          </h1>
          <div className="flex items-center gap-2 mt-2 text-neutral-500 text-sm">
            <Globe className="w-4 h-4" />
            <span>Domain: <span className="text-blue-400 font-mono">{MY_DOMAIN}</span></span>
          </div>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-auto lg:h-[600px]">
          <div className="lg:col-span-4 bg-neutral-900 border border-neutral-800 rounded-[2rem] overflow-hidden flex flex-col min-h-[300px]">
          ...
          <div className="lg:col-span-8 bg-neutral-900 border border-neutral-800 rounded-[2rem] overflow-hidden flex flex-col shadow-2xl min-h-[400px]">
            {selectedMessage ? (
              <>
                <div className="p-6 border-b border-neutral-800 bg-neutral-800/30">
                  <h3 className="text-xl font-bold text-white mb-4">{selectedMessage.subject}</h3>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-bold text-sm">{selectedMessage.from}</p>
                      <p className="text-[10px] text-neutral-500">{new Date(selectedMessage.date).toLocaleString()}</p>
                    </div>
                  </div>
                </div>
                <div className="flex-grow p-8 overflow-y-auto whitespace-pre-wrap font-sans text-neutral-300 leading-relaxed text-sm md:text-base">
